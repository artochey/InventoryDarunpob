using InventoryDarunpob.Pages.Siam;
using Microsoft.AspNetCore.Mvc.RazorPages;
using Microsoft.Data.SqlClient;

namespace test1.Pages.Siam

{
	public class EditSiamModel : PageModel
	{
		...
		public void Onpost()
		{
			...
			if (stockInfo.item.Length == 1 || stockInfo.storeid.Length == 2 ||
				stockInfo.supplier.Length == 1 || stockInfo.amount.Length == 1)
			{
